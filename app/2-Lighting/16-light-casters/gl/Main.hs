...
thisDir :: FilePath
thisDir = "app/2-Lighting/16-light-casters/"
...
mainState = do
  ...
  let loop :: StateT GameState IO () = do
          ...
          let lightPos = V3 (3 * cos timef) 2 (3 * sin timef)
          ...
          setUniformf  shaderCube "light.constant" 1
          setUniformf  shaderCube "light.linear" 0.09
          setUniformf  shaderCube "light.quadratic" 0.032
