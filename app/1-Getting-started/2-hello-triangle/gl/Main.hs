...
import Paths_learnopengl_haskell
...
main = do
  ...
  putStrLn "coucou"
  hFlush stdout
  vertexPath <- getDataFileName "app/1-Getting-started/2-hello-triangle/gl/shaders/vertex.glsl"
  vertexShader <- compileVertexShader  "app/1-Getting-started/2-hello-triangle/gl/shaders/vertex.glsl"
